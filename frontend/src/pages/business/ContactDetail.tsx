...
export default function ContactDetail() {
  ...
  // Seed the editable fields once the card loads. Adjusting state during
  // render (rather than in an effect) avoids the extra cascading render.
  const [seededFrom, setSeededFrom] = useState<typeof card.data>(undefined);
  if (card.data && card.data !== seededFrom) {
    setSeededFrom(card.data);
